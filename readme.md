...
2) Clone this repository with `git clone [https://github.com/KarinaSzubert/headspace-xr-prototype.git]`
3) Open the repository with PyCharm. You can do this by going file->open and selecting the cloned folder called `headspace-xr`
4) Configure your project interpreter. Go to file->settings, and selecting Python Interpreter under `Project: headspace-xr`, and clicking Add Interpreter->Add Local Interpreter
...
12) On the terminal, navigate to `headspace-xr` and run `python manage.py migrate`
